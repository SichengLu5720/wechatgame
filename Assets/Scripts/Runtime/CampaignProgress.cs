...
namespace StairsCrowd.Runtime
{
    public static class CampaignProgress
    {
        ...
        public static string StorageKey {get{return Array.IndexOf(Environment.GetCommandLineArgs(),"-failureprogresstest")>=0||DailyChallengeProgress.Verification||FriendLeaderboardProgress.Verification?Key+".verification":Key;}}
